      ...
      <div className='max-w-[1240px] mx-auto py-12'>
        ...
        <div className='grid md:grid-cols-3'>
          ...
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
            ...
            <div>
              <p className='text-6xl font-bold py-4 flex'>15mbps</p>
            </div>
            <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                 <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Unlimited Internet.</p>
                <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Customer Data Protection.</p>
                ...
                <button className='w-full py-4 my-4'>KSH 5499/mo</button>
          ...
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
            ...
            <div>
              <p className='text-6xl font-bold py-4 flex'>20mbps</p>
            </div>
            ...
            <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                ...
                <button className='w-full py-4 my-4'>KSH 15999/mo</button>
